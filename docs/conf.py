...
project = 'molecool'
copyright = ("2020, Geemi Wellawatte. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A python package for analysing and visualizing molecular structures for MSF bootcamp',
     'Miscellaneous'),
]
